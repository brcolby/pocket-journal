...
const scenarios = [
  ...
  ["listen-empty", "listen", () => { resetToHome(); api.pj_sim_touch_tap(20, 50); api.pj_sim_touch_tap(20, 120); }],
  ["listen-list", "listen", () => { resetToHome(); api.pj_sim_seed_review_notes(); api.pj_sim_touch_tap(20, 50); api.pj_sim_touch_tap(20, 120); }],
  ["read-list", "read", () => { resetToHome(); api.pj_sim_seed_review_notes(); api.pj_sim_touch_tap(20, 50); api.pj_sim_touch_tap(20, 170); }],
  ["note-detail", "note_detail", () => { resetToHome(); api.pj_sim_set_note_count(1); api.pj_sim_touch_tap(20, 50); api.pj_sim_touch_tap(20, 120); api.pj_sim_touch_tap(20, 50); }],
  ["transcript-detail", "note_detail", () => { resetToHome(); api.pj_sim_seed_review_notes(); api.pj_sim_touch_tap(20, 50); api.pj_sim_touch_tap(20, 170); api.pj_sim_touch_tap(20, 50); }],
  ["time", "time", () => { resetToHome(); api.pj_sim_touch_tap(20, 125); }],
  ["alarm", "alarm", () => { resetToHome(); api.pj_sim_touch_tap(20, 125); api.pj_sim_touch_tap(20, 55); }],
  ["stopwatch", "stopwatch", () => { resetToHome(); api.pj_sim_touch_tap(20, 125); api.pj_sim_touch_tap(20, 94); }],
  ["timer", "timer", () => { resetToHome(); api.pj_sim_touch_tap(20, 125); api.pj_sim_touch_tap(20, 133); }],
  ["interval", "interval", () => { resetToHome(); api.pj_sim_touch_tap(20, 125); api.pj_sim_touch_tap(20, 172); }],
  ["settings", "settings", () => { resetToHome(); api.pj_sim_touch_tap(20, 170); }],
  ["sync", "sync", () => { resetToHome(); api.pj_sim_touch_tap(20, 170); api.pj_sim_touch_tap(20, 55); }],
  ["volume", "volume", () => { resetToHome(); api.pj_sim_touch_tap(20, 170); api.pj_sim_touch_tap(20, 94); }],
