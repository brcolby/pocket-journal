...
const scenarios = [
  ...
  ["notes", "notes", () => { resetToHome(); api.pj_sim_touch_tap(20, 30); }],
  ["record-active", "record", () => { api.pj_sim_reset(); api.pj_sim_aux_double(); }],
  ["listen-empty", "listen", () => { resetToHome(); api.pj_sim_touch_tap(20, 30); api.pj_sim_touch_tap(20, 120); }],
  ["listen-list", "listen", () => { resetToHome(); api.pj_sim_set_note_count(3); api.pj_sim_touch_tap(20, 30); api.pj_sim_touch_tap(20, 120); }],
  ["read-list", "read", () => { resetToHome(); api.pj_sim_set_note_count(3); api.pj_sim_touch_tap(20, 30); api.pj_sim_touch_tap(150, 120); }],
  ["note-detail", "note_detail", () => { resetToHome(); api.pj_sim_set_note_count(1); api.pj_sim_touch_tap(20, 30); api.pj_sim_touch_tap(20, 120); api.pj_sim_touch_tap(60, 30); }],
  ["time", "time", () => { resetToHome(); api.pj_sim_touch_tap(150, 30); }],
  ["alarm", "alarm", () => { resetToHome(); api.pj_sim_touch_tap(150, 30); api.pj_sim_touch_tap(20, 30); }],
  ["stopwatch", "stopwatch", () => { resetToHome(); api.pj_sim_touch_tap(150, 30); api.pj_sim_touch_tap(150, 30); }],
  ["timer", "timer", () => { resetToHome(); api.pj_sim_touch_tap(150, 30); api.pj_sim_touch_tap(20, 130); }],
  ["interval", "interval", () => { resetToHome(); api.pj_sim_touch_tap(150, 30); api.pj_sim_touch_tap(150, 130); }],
  ["settings", "settings", () => { resetToHome(); api.pj_sim_touch_tap(20, 130); }],
  ["sync", "sync", () => { resetToHome(); api.pj_sim_touch_tap(20, 130); api.pj_sim_touch_tap(20, 30); }],
  ["volume", "volume", () => { resetToHome(); api.pj_sim_touch_tap(20, 130); api.pj_sim_aux_short(); }],
];
