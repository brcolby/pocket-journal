...
- Agents may create frequent, focused local commits without requesting per-commit approval.
- Do not push commits, tags, Beads data, or other refs unless the user explicitly requests it.
