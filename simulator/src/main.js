...
const REVIEW_ROUTES = {
  ...
  listen: ["wake", "aux", [20, 50], [20, 120]],
  read: ["wake", "aux", [20, 50], [20, 170]],
  time: ["wake", "aux", [20, 125]],
  alarm: ["wake", "aux", [20, 125], [20, 55]],
  stopwatch: ["wake", "aux", [20, 125], [20, 94]],
  timer: ["wake", "aux", [20, 125], [20, 133]],
  interval: ["wake", "aux", [20, 125], [20, 172]],
  settings: ["wake", "aux", [20, 170]],
  sync: ["wake", "aux", [20, 170], [20, 55]],
  volume: ["wake", "aux", [20, 170], [20, 94]],
};
